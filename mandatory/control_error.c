...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/15 03:14:44 by sisen             #+#    #+#             */
/*   Updated: 2023/08/17 16:20:04 by sisen            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	show_error(int err)
{
	if (err == 0)
		...
		ft_putstr_fd("map can not open", 1);
	else if (err == 2)
		ft_putstr_fd("lines of the map are not equal", 1);
	else if (err == 3)
		ft_putstr_fd("stable limit exceeded", 1);
	else if (err == 4)
		ft_putstr_fd("wrong player number", 1);
	else if (err == 5)
		ft_putstr_fd("wrong exit number", 1);
	else if (err == 6)
